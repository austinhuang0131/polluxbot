...
let items = (await gear.items.find({id:{$in: inventory}})).filter(itm=>itm.type=='ring');
function iqnt(item){
  console.log(item)
  ...
  embed.setDescription(":card_box: **Marriage Rings Iventory**")
  //embed.addBlankField()
