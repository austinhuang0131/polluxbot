...
return;  
  ...
  //targetto = (await userDB.find({'modules.statistics.healthIndex':{$exists:true}, blacklisted:{$exists:false}},{_id:-1,id:1}).sort({'modules.statistics.healthIndex':1}).limit(25)).map(x=>x.id);
